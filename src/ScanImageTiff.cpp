...
PYBIND11_MODULE(scanimagetiffio, m)
{
	...
	py::class_<twophoton::SITiffIO>(m, "SITiffIO")
		.def(py::init<>())
		.def("open_tiff_file", &twophoton::SITiffIO::openTiff, "Open a tiff file", py::arg("fname"), py::arg("'r' or 'w'"))
		...
		.def("open_log_file", &twophoton::SITiffIO::openLog, "Open a log file", py::arg("fname"))
		.def("open_xml_file", &twophoton::SITiffIO::openXML, "Open an xml file", py::arg("fname"))
		...
		.def("get_frame", &twophoton::SITiffIO::readFrame, "Gets the data/ image for the given frame", py::arg("i_frame"))
		.def("write_frame", &twophoton::SITiffIO::writeFrame, "Write frame to file", py::arg("frame"), py::arg("i_frame"))
